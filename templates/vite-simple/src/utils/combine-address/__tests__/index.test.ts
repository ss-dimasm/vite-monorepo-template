...
describe('combineAddress', () => {
  it('should correctly combine address for variant base', () => {
    const address = {
      buildingName: '123',
      buildingNumber: '65',
      line1: 'Lindsey Close',
  ...
  it('should correctly combine address for variant 1', () => {
    const address = {
      buildingNumber: '65',
      line1: 'Lindsey Close',
      line2: 'Great Denham',
  ...
  it('should correctly combine address for variant 2', () => {
    const address = {
      buildingName: '123',
      line1: 'Lindsey Close',
      line2: 'Great Denham',
  ...
  it('should correctly combine address for variant 3', () => {
    const address = {
      buildingName: '123',
      buildingNumber: '65',
      line2: 'Great Denham',
  ...
  it('should correctly combine address for variant 4', () => {
    const address = {
      buildingName: '123',
      buildingNumber: '65',
      line1: 'Lindsey Close',
  ...
  it('should correctly combine address for variant 5', () => {
    const address = {
      buildingName: '123',
      buildingNumber: '65',
      line1: 'Lindsey Close',
  ...
  it('should correctly combine address for variant 6', () => {
    const address = {
      buildingName: '123',
      buildingNumber: '65',
      line1: 'Lindsey Close',
  ...
  it('should correctly combine address for variant 7', () => {
    const address = {
      buildingName: '123',
      buildingNumber: '65',
      line1: 'Lindsey Close',
  ...
  it('should correctly combine address for variant 8', () => {
    const address = {
      buildingName: '123',
      buildingNumber: '65',
      line1: 'Lindsey Close',
